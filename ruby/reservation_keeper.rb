...
def add_flight(origin_airport, departure_time, destination_airport, arrival_time)
...
def add_flight_prompt
	...
	add_flight(origin_airport, departure_time, destination_airport, arrival_time)
end
